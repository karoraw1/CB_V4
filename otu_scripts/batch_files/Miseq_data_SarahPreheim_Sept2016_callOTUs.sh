...
#SBATCH
#SBATCH --job-name=Miseq_data_SarahPreheim_Sept2016_DADA2
#SBATCH --time=2:00:00
#SBATCH --ntasks=12
...
#SBATCH --error=DADA2_Miseq_data_SarahPreheim_Sept2016.err
#SBATCH --output=DADA2_Miseq_data_SarahPreheim_Sept2016.out
