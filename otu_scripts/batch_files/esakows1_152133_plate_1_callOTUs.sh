...
#SBATCH
#SBATCH --job-name=esakows1_152133_plate_1_DADA2
#SBATCH --time=5:00:00
#SBATCH --ntasks=24
...
#SBATCH --error=DADA2_esakows1_152133_plate_1.err
#SBATCH --output=DADA2_esakows1_152133_plate_1.out

module load R/3.5.1

SEQ_ID=esakows1_152133_plate_1
