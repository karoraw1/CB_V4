...
#SBATCH
#SBATCH --job-name=esakows1_152133_plate_2_DADA2
#SBATCH --time=5:00:00
#SBATCH --ntasks=48
...
#SBATCH --error=DADA2_esakows1_152133_plate_2.err
#SBATCH --output=DADA2_esakows1_152133_plate_2.out

module load R/3.5.1

SEQ_ID=esakows1_152133_plate_2
